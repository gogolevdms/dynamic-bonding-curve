...
pub struct MigrateMeteoraDammClaimLpTokenTransaction {
    pub instruction: MigrateMeteoraDammClaimLpTokenInstruction,
}
...
impl TransactionHooks for MigrateMeteoraDammClaimLpTokenTransaction {
