...
pub struct InitializeVirtualPoolWithToken2022Transaction {
    pub instruction: InitializeVirtualPoolWithToken2022Instruction,
}
...
impl TransactionHooks for InitializeVirtualPoolWithToken2022Transaction {
