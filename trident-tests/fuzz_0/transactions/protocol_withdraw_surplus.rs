...
pub struct ProtocolWithdrawSurplusTransaction {
    pub instruction: ProtocolWithdrawSurplusInstruction,
}
...
impl TransactionHooks for ProtocolWithdrawSurplusTransaction {
