...
pub struct ClaimCreatorTradingFeeTransaction {
    pub instruction: ClaimCreatorTradingFeeInstruction,
}
...
impl TransactionHooks for ClaimCreatorTradingFeeTransaction {
