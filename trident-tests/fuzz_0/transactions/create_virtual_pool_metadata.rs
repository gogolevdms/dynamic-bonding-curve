...
pub struct CreateVirtualPoolMetadataTransaction {
    pub instruction: CreateVirtualPoolMetadataInstruction,
}
...
impl TransactionHooks for CreateVirtualPoolMetadataTransaction {
