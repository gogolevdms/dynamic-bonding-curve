...
pub struct MigrateMeteoraDammLockLpTokenTransaction {
    pub instruction: MigrateMeteoraDammLockLpTokenInstruction,
}
...
impl TransactionHooks for MigrateMeteoraDammLockLpTokenTransaction {
