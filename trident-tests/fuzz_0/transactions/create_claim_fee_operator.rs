...
pub struct CreateClaimFeeOperatorTransaction {
    pub instruction: CreateClaimFeeOperatorInstruction,
}
...
impl TransactionHooks for CreateClaimFeeOperatorTransaction {
