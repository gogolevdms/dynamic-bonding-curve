...
pub struct MigrationMeteoraDammCreateMetadataTransaction {
    pub instruction: MigrationMeteoraDammCreateMetadataInstruction,
}
...
impl TransactionHooks for MigrationMeteoraDammCreateMetadataTransaction {
