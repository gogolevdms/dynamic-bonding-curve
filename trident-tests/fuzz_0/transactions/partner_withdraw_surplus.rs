...
pub struct PartnerWithdrawSurplusTransaction {
    pub instruction: PartnerWithdrawSurplusInstruction,
}
...
impl TransactionHooks for PartnerWithdrawSurplusTransaction {
