...
pub struct InitializeVirtualPoolWithSplTokenTransaction {
    pub instruction: InitializeVirtualPoolWithSplTokenInstruction,
}
...
impl TransactionHooks for InitializeVirtualPoolWithSplTokenTransaction {
