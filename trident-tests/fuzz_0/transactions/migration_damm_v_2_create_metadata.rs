...
pub struct MigrationDammV2CreateMetadataTransaction {
    pub instruction: MigrationDammV2CreateMetadataInstruction,
}
...
impl TransactionHooks for MigrationDammV2CreateMetadataTransaction {
