...
pub struct CreatorWithdrawSurplusTransaction {
    pub instruction: CreatorWithdrawSurplusInstruction,
}
...
impl TransactionHooks for CreatorWithdrawSurplusTransaction {
